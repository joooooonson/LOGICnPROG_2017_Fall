...
class MyForm(QMainWindow, mainwindow.Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # UPDATE PUSH BUTTON
        self.pushButton_save.clicked.connect(self.save_button_clicked)
        # EXIT
    ...
    def push_load_countries(self):
        ...
        if len(self.countries) > 0:
            ...
            # self.widget_countryinfo.setVisible(True)
    ...
    def save_button_clicked(self):
        ...
        # else:
        #     QMessageBox.information(self, 'Saved', 'Failed to save', QMessageBox.Ok)
    ...
    def set_area_in_selected_unit(self, selectedIndex):
        ...
        if selectedIndex == 0:
            ...
            self.label_numberofarea.setText(self.thousand_separator("{:.2f}".format(area_in_km)))
