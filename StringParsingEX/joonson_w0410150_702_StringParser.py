...
def my_upper(input_str):
    # return converted to upper case version
...
while input_string.lower() != 'quit':
    if input_validation(input_string):
        print("ALL UPPER : " + my_upper(input_string))
        print("TITLE : " + my_title(input_string))
        print("FIRST LETTER : " + first_letter(input_string))
        print("LAST LETTER : " + last_letter(input_string))
        print("NUMBER OF SPACES : " + str(get_number_of_spaces(input_string)))
        print("NUMBER OF CHARACTERS : " + str(get_number_of_char(input_string)))
        print("INDEX OF FIRST SPACE : " + str(get_first_space_index(input_string)))
        print("INDEX OF SECOND SPACE : " + str(get_second_space_index(input_string)))
        print("FIRST WORD : " + get_first_word(input_string))
        print("SECOND WORD : " + get_second_word(input_string, get_second_space_index(input_string)))
        print("NUMBER OF 'E' : " + str(get_number_of_e(input_string)))
        print("LAST LETTER IN ALPHABET ORDER : " + get_max_in_alphaorder(input_string))
        print("REPLACE SPACE WITH UNDERSCORE : " + my_replace(input_string, '_', ' '))
    else:
